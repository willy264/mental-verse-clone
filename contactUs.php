...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link href="both/bootstrap-5.3.3-dist/css/bootstrap.css" rel="stylesheet">
...
<body>
    ...
    <section class="container">
        <div class="row row-cols-2 align-items-center">
            ...
            <form class="col py-5" action="inc/messages/send-message-to-admin.php" method="post">
                <div class="mx-4 mb-4">
                ...
                <div class="mx-4 mb-4">
                    <button type="submit" class="send" name="submit">SEND MESSAGE</button>
                </div>
            </form>
        </div>
    </section>
    ...
    <script src="both/bootstrap-5.3.3-dist/js/bootstrap.min.js"></script>
</body>

...
function switchPrice(checked) {
  ...
  if (checked) {
    prices[0].innerHTML = `$${yearlyPrice[0]}/yr <p>2 months free</p>`;
    prices[1].innerHTML = `$${yearlyPrice[1]}/yr <p>2 months free</p>`;
    prices[2].innerHTML = `$${yearlyPrice[2]}/yr <p>2 months free</p>`;
    setTime(true)
  } else {
